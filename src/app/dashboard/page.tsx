  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((level) => {
            ...
            return (
              <div
                key={level}
                className={`relative bg-white rounded-2xl shadow-xl p-8 transition-all duration-300 dark:bg-gray-800 dark:shadow-gray-700 ${
                  isLocked
                ...
                {isLocked && (
                  <div className="absolute inset-0 bg-gray-900 bg-opacity-50 rounded-2xl flex items-center justify-center">
                    <div className="text-white text-center">
                      ...
                      <p className="text-sm">
                        {t("dashboard.contactAdminUnlock")}
                      </p>
                    </div>
                  </div>
                )}
        ...
        {/* Statistics Section */}
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8 dark:bg-gray-800 dark:shadow-gray-700">
