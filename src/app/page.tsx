...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className="bg-white text-gray-800 font-semibold py-4 px-8 rounded-lg border-2 border-gray-300 hover:border-gray-400 transition transform hover:scale-105 text-lg dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:border-gray-500"
            >
              {t("home.learnMore")}
            </button>
          </div>
      ...
      <section
        id="features"
        className="py-20 px-4 bg-white bg-opacity-50 dark:bg-gray-800 dark:bg-opacity-50"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition transform hover:scale-105 dark:bg-gray-800 dark:shadow-gray-700">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center bg-white rounded-2xl shadow-xl p-12 dark:bg-gray-800 dark:shadow-gray-700">
